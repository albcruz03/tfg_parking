...
area9=[(494,10),(614,3),(632,36),(514,56)]
...
#        print(row)
    ...
    if a9==1:
        ...
        cv2.putText(frame,str('9'),(615,10),cv2.FONT_HERSHEY_COMPLEX,0.5,(0,0,255),1)
    else:
        cv2.polylines(frame,[np.array(area9,np.int32)],True,(0,255,0),2)
        cv2.putText(frame,str('9'),(615,10),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,255),1)
